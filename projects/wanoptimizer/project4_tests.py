...
from tests import *
from kyle_hotchkiss import *
from eric_tests import *
from send_fin_overload_buffer import *
...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true")
    parser.add_argument(
        "--data-reduction-with-jumbled-files",
    ...
    parser.add_argument(
        ...
        action="store_true")
    parser.add_argument(
        "--test-delimiter-at-end-without-fin",
        dest="test_delimiter_at_end_without_fin",
        action="store_true")
    parser.add_argument(
        "--test-delimiter-in-middle-with-fin-after",
        dest="test_delimiter_in_middle_with_fin_after",
        action="store_true"
        )
    parser.add_argument(
        "--test-delimiter-at-end-with-fin",
        dest="test_delimiter_at_end_with_fin",
        action="store_true"
        )
    parser.add_argument(
        "--test-right-partitions",
